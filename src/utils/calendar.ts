export function generateGoogleCalendarUrl(): string {
  ...
  const details = encodeURIComponent(
    ...
    '• Local: Interne, Rua Marques Amorim, 356, Boa Vista, Recife/PE\n' +
  ...
  const location = encodeURIComponent('Interne, Rua Marques Amorim, 356, Boa Vista, Recife - PE, 50070-330');
